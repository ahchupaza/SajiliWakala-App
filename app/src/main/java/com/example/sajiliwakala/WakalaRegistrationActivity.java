...
public class WakalaRegistrationActivity extends AppCompatActivity {
    ...
    private EditText ID_no, fname, mname, lname, birthdate, licence_no, SIM_no, code_no, TIN_no, busns_region;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registerButton = (Button) findViewById(R.id.wakala_register_button);
    ...
    private void registerWakala() {
        ...
        progressBar.setVisibility(View.VISIBLE);
             ...
             Wakala wakala =  new  Wakala(ID, first_name, middle_name, last_name, dob, licence, SIM, code, TIN, region);
